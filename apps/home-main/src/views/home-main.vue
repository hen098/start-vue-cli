<template>
  ...
  <v-container>
    <v-layout align-center column>
      <v-text-field id="1bEmail" v-model="email" label="E-mail"></v-text-field>

      <v-btn id="btnLongin" color="warning" @click="clickLogin">Login</v-btn>
